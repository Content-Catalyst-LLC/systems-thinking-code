...
REQUIRED = [
    "senge_learning_organization_timeseries.csv",
    "senge_learning_organization_summary.csv",
]
...
def main() -> None:
    ...
    rows = list(csv.DictReader((TABLES / "senge_learning_organization_timeseries.csv").open("r", encoding="utf-8")))
    if not rows:
