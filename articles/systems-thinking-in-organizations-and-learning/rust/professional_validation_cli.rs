// Professional validation CLI for Systems Thinking in Organizations and Learning
...
fn main() {
    ...
    println!("article_slug,systems-thinking-in-organizations-and-learning"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
