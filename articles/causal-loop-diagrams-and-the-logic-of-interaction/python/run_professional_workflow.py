#!/usr/bin/env python3
"""
Professional systems analysis workflow for: Causal Loop Diagrams and the Logic of Interaction
...
PROFILE = {
  "article_slug": "causal-loop-diagrams-and-the-logic-of-interaction",
  "article_title": "Causal Loop Diagrams and the Logic of Interaction",
  "family": "modeling_methods",
  "stock_label": "dynamic system stock",
  "pressure_label": "model uncertainty and intervention pressure",
  "burden_label": "assumption burden",
  "outcome_label": "system performance",
  "capacity_label": "modeling capacity",
  "trust_label": "interpretive confidence",
  "memory_label": "model memory",
  "base_stock": 82,
  "base_capacity": 51,
  "base_trust": 50,
  "base_memory": 49,
  ...
  "equity_gap": 20,
  "demand_growth": 2.0,
  "regeneration_rate": 0.027,
  "degradation_rate": 4.3,
  "policy_delay": 4,
  "shock_year": 10
}
