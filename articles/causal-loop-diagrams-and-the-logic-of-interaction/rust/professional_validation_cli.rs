// Professional validation CLI for Causal Loop Diagrams and the Logic of Interaction
...
fn main() {
    ...
    println!("article_slug,causal-loop-diagrams-and-the-logic-of-interaction"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
