#!/usr/bin/env julia
# Professional dynamic sensitivity model for Causal Loop Diagrams and the Logic of Interaction
function clamp01(x, lo=0.0, hi=100.0)
    return max(lo, min(hi, x))
end
base_stock = 82; base_capacity = 51; base_burden = 34
regen = 0.027; degrade = 4.3
