#!/usr/bin/env python3
"""
Professional systems analysis workflow for: Overshoot Collapse and Correction
...
PROFILE = {
  "article_slug": "overshoot-collapse-and-correction",
  "article_title": "Overshoot Collapse and Correction",
