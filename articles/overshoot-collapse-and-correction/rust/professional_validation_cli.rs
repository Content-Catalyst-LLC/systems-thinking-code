// Professional validation CLI for Overshoot Collapse and Correction
...
fn main() {
    ...
    println!("article_slug,overshoot-collapse-and-correction"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
