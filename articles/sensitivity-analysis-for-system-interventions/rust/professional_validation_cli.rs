// Professional validation CLI for Sensitivity Analysis For System Interventions
...
fn main() {
    ...
    println!("article_slug,sensitivity-analysis-for-system-interventions"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
