// Professional validation CLI for Behavior Over Time and Structural Explanation
...
fn main() {
    ...
    println!("article_slug,behavior-over-time-and-structural-explanation"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
