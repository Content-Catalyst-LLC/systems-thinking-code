// Professional validation CLI for Systems Thinking and Sustainability
...
fn main() {
    ...
    println!("article_slug,systems-thinking-and-sustainability"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
