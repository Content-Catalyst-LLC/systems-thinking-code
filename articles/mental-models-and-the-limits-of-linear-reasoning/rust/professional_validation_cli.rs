// Professional validation CLI for Mental Models and the Limits of Linear Reasoning
...
fn main() {
    ...
    println!("article_slug,mental-models-and-the-limits-of-linear-reasoning"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
