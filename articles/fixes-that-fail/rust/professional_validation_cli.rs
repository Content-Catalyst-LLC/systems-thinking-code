// Professional validation CLI for Fixes That Fail
...
fn main() {
    ...
    println!("article_slug,fixes-that-fail"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
