// Professional validation CLI for Limits to Growth
...
fn main() {
    ...
    println!("article_slug,limits-to-growth"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
