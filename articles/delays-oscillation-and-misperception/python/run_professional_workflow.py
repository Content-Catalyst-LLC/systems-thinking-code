#!/usr/bin/env python3
"""
Professional systems analysis workflow for: Delays Oscillation and Misperception
...
PROFILE = {
  "article_slug": "delays-oscillation-and-misperception",
  "article_title": "Delays Oscillation and Misperception",
