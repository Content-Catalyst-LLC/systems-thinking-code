#!/usr/bin/env python3
"""
Professional systems analysis workflow for: Systems Thinking in Public Policy
...
PROFILE = {
  "article_slug": "systems-thinking-in-public-policy",
  "article_title": "Systems Thinking in Public Policy",
