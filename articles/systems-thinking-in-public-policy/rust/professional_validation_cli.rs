// Professional validation CLI for Systems Thinking in Public Policy
...
fn main() {
    ...
    println!("article_slug,systems-thinking-in-public-policy"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
