...
fn main() {
    let sample_values = vec![42.5, 58.0, 74.2, -12.0];
    ...
    fs::write(
        out_dir.join("rust_cybernetic_system_validation_report.txt"),
        "Rust validation passed: all sample cybernetic indicators are bounded.\n",
