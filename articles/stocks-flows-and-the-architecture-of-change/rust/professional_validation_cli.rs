// Professional validation CLI for Stocks Flows and the Architecture of Change
...
fn main() {
    ...
    println!("article_slug,stocks-flows-and-the-architecture-of-change"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
