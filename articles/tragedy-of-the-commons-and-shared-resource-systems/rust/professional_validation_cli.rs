// Professional validation CLI for Tragedy of the Commons and Shared Resource Systems
...
fn main() {
    ...
    println!("article_slug,tragedy-of-the-commons-and-shared-resource-systems"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
