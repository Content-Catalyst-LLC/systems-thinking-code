#!/usr/bin/env python3
"""
Professional systems analysis workflow for: Causality in Systems Thinking
...
PROFILE = {
  "article_slug": "causality-in-systems-thinking",
  "article_title": "Causality in Systems Thinking",
