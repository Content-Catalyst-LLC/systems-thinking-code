// Professional validation CLI for Causality in Systems Thinking
...
fn main() {
    ...
    println!("article_slug,causality-in-systems-thinking"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
