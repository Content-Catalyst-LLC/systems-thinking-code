// Professional validation CLI for Feedback Loop Polarity and Causal Signs
...
fn main() {
    ...
    println!("article_slug,feedback-loop-polarity-and-causal-signs"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
