#!/usr/bin/env python3
"""
Professional systems analysis workflow for: Feedback Loop Polarity and Causal Signs
...
PROFILE = {
  "article_slug": "feedback-loop-polarity-and-causal-signs",
  "article_title": "Feedback Loop Polarity and Causal Signs",
