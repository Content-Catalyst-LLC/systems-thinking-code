#!/usr/bin/env python3
"""
Professional systems analysis workflow for: Scenario Modeling in Systems Thinking
...
PROFILE = {
  "article_slug": "scenario-modeling-in-systems-thinking",
  "article_title": "Scenario Modeling in Systems Thinking",
