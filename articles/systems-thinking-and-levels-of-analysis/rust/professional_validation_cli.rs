// Professional validation CLI for Systems Thinking and Levels of Analysis
...
fn main() {
    ...
    println!("article_slug,systems-thinking-and-levels-of-analysis"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
