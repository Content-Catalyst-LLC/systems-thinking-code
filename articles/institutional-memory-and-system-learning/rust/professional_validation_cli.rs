// Professional validation CLI for Institutional Memory and System Learning
...
fn main() {
    ...
    println!("article_slug,institutional-memory-and-system-learning"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
