// Professional validation CLI for Organizational Burnout as a System Pattern
...
fn main() {
    ...
    println!("article_slug,organizational-burnout-as-a-system-pattern"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
