// Professional validation CLI for Systems Thinking in Governance and Public Institutions
...
fn main() {
    ...
    println!("article_slug,systems-thinking-in-governance-and-public-institutions"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
