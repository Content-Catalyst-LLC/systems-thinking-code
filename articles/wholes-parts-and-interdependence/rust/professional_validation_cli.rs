// Professional validation CLI for Wholes Parts and Interdependence
...
fn main() {
    ...
    println!("article_slug,wholes-parts-and-interdependence"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
