// Professional validation CLI for Stock Flow Thinking in Social Systems
...
fn main() {
    ...
    println!("article_slug,stock-flow-thinking-in-social-systems"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
