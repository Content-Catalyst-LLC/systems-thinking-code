// Professional validation CLI for Shifting the Burden
...
fn main() {
    ...
    println!("article_slug,shifting-the-burden"); println!("row_count,{}", row_count); println!("high_risk_rows,{}", high_risk_count);
